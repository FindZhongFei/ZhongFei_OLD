...
//        linearLayoutManager.setStackFromEnd(true);
    ...
    private void sendMessage() {
        ...
        {
            ChatMessages chatMessages = new ChatMessages("ID", MESSAGE_VALUE, String.valueOf(new Date().getTime()), new ChatUser(mUserProfile.getUserToken(), mUserProfile.getUserFirstName(), mUserProfile.getUserEmail()));
